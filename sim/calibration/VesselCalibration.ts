...
> = {
  trawler: {
    ...
    speed: {
      steadySpeedMps: { min: 2.55, max: 3.1 },
      maximumSpeedMaxMps: 3.3,
      timeToMinimumCruiseMaxSeconds: 22,
      maximumRollDeg: 10,
      maximumPitchDeg: 12,
    },
    'reverse-speed': {
      steadyAsternSpeedMps: { min: 1.2, max: 1.9 },
      maximumAsternSpeedMaxMps: 2.1,
      timeToMinimumAsternMaxSeconds: 22,
      maximumWrongWayForwardSpeedMps: 0.75,
      maximumRollDeg: 12,
      maximumPitchDeg: 15,
    },
    stop: {
      cutoffSpeedMps: { min: 2.4, max: 3.2 },
      stoppingTimeSeconds: { min: 1, max: 18 },
      stoppingDistanceM: { min: 4, max: 40 },
      finalSpeedMaxMps: 0.5,
    },
    turn: {
      entrySpeedMps: { min: 2, max: 3.2 },
      headingChangeMinDeg: 100,
      turnRadiusM: { min: 4, max: 18 },
      maximumRollDeg: 24,
    },
    'reverse-turn': {
      entryAsternSpeedMps: { min: 0.8, max: 1.9 },
      headingChangeMinDeg: 70,
      turnRadiusM: { min: 3, max: 20 },
      maximumRollDeg: 24,
      maximumPitchDeg: 18,
    },
  },
  speedboat: {
    ...
    speed: {
      steadySpeedMps: { min: 13.5, max: 15.6 },
      maximumSpeedMaxMps: 16.2,
      timeToMinimumCruiseMaxSeconds: 20,
      maximumRollDeg: 25,
      maximumPitchDeg: 35,
    },
    'reverse-speed': {
      steadyAsternSpeedMps: { min: 3.5, max: 6.5 },
      maximumAsternSpeedMaxMps: 7,
      timeToMinimumAsternMaxSeconds: 22,
    ...
    stop: {
      cutoffSpeedMps: { min: 12, max: 16 },
      stoppingTimeSeconds: { min: 1.5, max: 20 },
      stoppingDistanceM: { min: 9.6, max: 44.8 },
      finalSpeedMaxMps: 0.8,
    },
    turn: {
      entrySpeedMps: { min: 11.5, max: 16 },
      headingChangeMinDeg: 110,
      turnRadiusM: { min: 4.8, max: 22.4 },
      maximumRollDeg: 30,
    },
    'reverse-turn': {
      entryAsternSpeedMps: { min: 3, max: 7 },
      headingChangeMinDeg: 80,
      turnRadiusM: { min: 3.5, max: 18 },
      maximumRollDeg: 30,
      maximumPitchDeg: 40,
    },
  },
